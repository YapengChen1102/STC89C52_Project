...
void get_key(void)
{
	...
	P3 = ( P3 & 0xC0) | 0x30;
	P4 = ( P4 & 0xEB) | 0x14;
	if( P3_4 == 0 ) {while(P3_4==0); column = 3; goto SEG2;}
	if( P3_5 == 0 ) {while(P3_5==0); column = 2; goto SEG2;}
	if( P4_2 == 0 ) {while(P4_2==0); column = 1; goto SEG2;}
	if( P4_4 == 0 ) {while(P4_4==0); column = 0; goto SEG2;}
	return;
	SEG2:
